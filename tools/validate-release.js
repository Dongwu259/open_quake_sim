...
function checkDocumentation() {
  ...
  check(/v6\.0/.test(json('public/manifest.json').description || ''), 'manifest version is not v6.0');
  check(json('package.json').version === '6.0.0', 'package version is not the 6.0.0 release');
