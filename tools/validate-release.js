...
function checkDocumentation() {
  ...
  check(/v6\.1/.test(json('public/manifest.json').description || ''), 'manifest version is not v6.1');
  check(json('package.json').version === '6.1.0', 'package version is not the 6.1.0 release');
