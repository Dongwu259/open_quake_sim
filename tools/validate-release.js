...
function checkDocumentation() {
  ...
  check(/v5\.6/.test(json('public/manifest.json').description || ''), 'manifest version is not v5.6');
  check(json('package.json').version === '5.6.0', 'package version is not the 5.6.0 release');
