...
(function(root) {
  ...
  // 12-degree (CSIS) cue set: Intensity1..12.wav, generated by
  // tools/generate-intensity12-sounds.js. Lazy: never boot-preloaded - the
  // first play fetches and decodes on demand (app.js shows a download prompt).
  AudioManager.getIntensity12Name = function(level) {
